...
use backend\models\OrdonatoriSearch;
...
class OrdonatoriController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            Yii::$app->db->createCommand('INSERT INTO log(id_user_log, action_log, tabela_log, id_model_log, data_log, ip_log) VALUES ('.Yii::$app->user->identity->id.',"ADĂUGARE", "ORDONATORI", "'.$model->id.'","'.$datetime.'","'.$ip.'");')->execute();
